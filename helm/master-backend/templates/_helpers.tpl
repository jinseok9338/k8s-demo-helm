...
*/}}
{{- define "master-backend.fullname" -}}
...
helm.sh/chart: {{ include "master-backend.chart" . }}
...
{{- default (include "master-backend.fullname" .) .Values.serviceAccount.name }}
{{- else }}
