...
*/}}
{{- define "master-frontend.fullname" -}}
...
helm.sh/chart: {{ include "master-frontend.chart" . }}
...
{{- default (include "master-frontend.fullname" .) .Values.serviceAccount.name }}
{{- else }}
